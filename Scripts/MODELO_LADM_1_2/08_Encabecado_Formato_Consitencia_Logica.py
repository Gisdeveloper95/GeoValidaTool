    ...
    def get_project_root(self):
        ...
        while current.parent != current:
            required_paths = [
                ...
                current / "Files" / "Temporary_Files" / "MODELO_LADM_1_2" / "02_TOPOLOGIA"
            ]
        ...
        try:
            ...
            for dataset in arcpy.ListDatasets('*', 'Feature'):
                ...
                for fc in arcpy.ListFeatureClasses('*', feature_dataset=dataset):
                    # Verificar si el feature class contiene alguno de los nombres objetivo
            ...
            for excel_path in excel_files:
                try:
                    ...
                    if sheet_name in workbook.sheetnames:
                        ...
                        # Usar las celdas correctas para los valores combinados
                        try:
