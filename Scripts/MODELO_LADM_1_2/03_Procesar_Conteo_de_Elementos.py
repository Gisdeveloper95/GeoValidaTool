...
def obtener_ruta_base():
    ...
    ruta_gpkg = os.path.join(ruta_proyecto, "Files", "Temporary_Files", "MODELO_LADM_1_2", "GPKG_ORIGINAL")
    
    if not os.path.exists(ruta_gpkg):
        raise Exception(
            "No se encontró la ruta del GPKG.\n"
            "Verifique que existe la siguiente estructura:\n"
            "- GeoValidaTool/Files/Temporary_Files/MODELO_LADM_1_2/GPKG_ORIGINAL"
        )
...
def obtener_gpkg_path():
    ...
    ruta_gpkg = os.path.join(ruta_base, "Files", "Temporary_Files", "MODELO_LADM_1_2", "GPKG_ORIGINAL")
