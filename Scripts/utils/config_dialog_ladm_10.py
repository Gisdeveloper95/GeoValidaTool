...
class ConfigDialogLADM10(QDialog):
    def __init__(self, parent=None):
        super().__init__(parent)
        self.parent = parent
        self.setWindowTitle("Configuración de Insumos LADM 1.0")
    ...
    def setup_directories(self):
        ...
        self.json_path = os.path.join(self.json_dir, "rutas_archivos_ladm_1_0.json")

    def setup_ui(self):
        layout = QVBoxLayout(self)
        layout.setSpacing(10)
        
        # Header con estilo distintivo para LADM 1.0
        header_layout = QHBoxLayout()
        title_label = QLabel("Configuración de Rutas GPKG - LADM 1.0")
        ...
        # Banner informativo específico para LADM 1.0
        info_frame = QFrame()
        ...
        info_label = QLabel(
            "ℹ️ Nota: Para el modelo LADM 1.0, asegúrese de seleccionar archivos GPKG "
            "que cumplan con las especificaciones de la versión 1.0 del modelo LADM_COL."
        )
        info_label.setStyleSheet("color: #186A3B; font-style: italic;")
    ...
    def validate_gpkg_version(self, file_path, gpkg_type):
        """Validación básica para LADM 1.0"""
        try:
            ...
            # Se podrían agregar más validaciones específicas para LADM 1.0 aquí
