...
class WordAutomation:
    ...
    def get_municipality_info(self, dataset):
        ...
        try:
            ...
            feature_class = "U_MANZANA_CTM12" if "URBANO" in dataset else "R_VEREDA_CTM12"
    ...
    def get_consistencia_variables(self, dataset):
        ...
        try:
            ...
            SELECT (
                ...
                U_TERRENO_CTM12 + 
                U_NOMENCLATURA_VIAL_CTM12 +
                U_TERRENO_CTM12_U_MANZANA_CTM12 + 
                U_UNIDAD_CTM12_U_TERRENO_CTM12 +
                U_NOMEN_DOMICILIARIA_CTM12 + 
                U_UNIDAD_CTM12_U_CONSTRUCCION_CTM12 +
                U_NOMEN_DOMICILIARIA_CTM12_U_TERRENO_CTM12 + 
                U_MANZANA_CTM12 +
                U_BARRIO_CTM12 + 
                U_CONSTRUCCION_CTM12_U_TERRENO_CTM12 +
                U_CONSTRUCCION_CTM12 + 
                U_MANZANA_CTM12_U_SECTOR_CTM12 +
                U_SECTOR_CTM12
    ...
    def verify_database_integrity(self):
        ...
        integrity_checks = {
            'conteo': [
                ...
                "SELECT * FROM URBANO_CTM12 LIMIT 1"
            ],
            'errores': [
                "SELECT name FROM sqlite_master WHERE type='table'",
                "SELECT * FROM URBANO_CTM12 LIMIT 1"
