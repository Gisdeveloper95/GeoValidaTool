...
try:
    ...
    if "RURAL_CTM12" in DATASETS_TO_PROCESS:
        print("Ejecutando 21_Reporte_final_RURAL_CTM12.py...")
        subprocess.run(["python", os.path.join(script_dir, "21_Reporte_final_RURAL_CTM12.py")])

    if "URBANO_CTM12" in DATASETS_TO_PROCESS:
        print("Ejecutando 21_Reporte_final_URBANO_CTM12.py...")
        subprocess.run(["python", os.path.join(script_dir, "21_Reporte_final_URBANO_CTM12.py")])

        # Ejecutar los scripts según los datasets en DATASETS_TO_PROCESS
    if "RURAL" in DATASETS_TO_PROCESS:
        print("Ejecutando 21_Reporte_final_RURAL.py...")
        subprocess.run(["python", os.path.join(script_dir, "21_Reporte_final_RURAL.py")])

    if "URBANO" in DATASETS_TO_PROCESS:
        print("Ejecutando 21_Reporte_final_URBANO_CTM12.py...")
        subprocess.run(["python", os.path.join(script_dir, "21_Reporte_final_URBANO.py")])
    ...
    print("Ejecutando 21_Reporte_final_RURAL.py...")
    subprocess.run(["python", os.path.join(script_dir, "21_Reporte_final_RURAL.py")])
    print("Ejecutando 21_Reporte_final_URBANO.py...")
    subprocess.run(["python", os.path.join(script_dir, "21_Reporte_final_URBANO.py")])
