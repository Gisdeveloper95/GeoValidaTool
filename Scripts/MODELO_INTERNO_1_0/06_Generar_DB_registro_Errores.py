...
def find_project_root():
    ...
    rutas_requeridas = [
        os.path.join(ruta_proyecto, "Files", "Temporary_Files", "MODELO_INTERNO_1_0"),
    ...
    if all(os.path.exists(ruta) for ruta in rutas_requeridas):
        ...
        db_dir = os.path.join(ruta_proyecto, "Files", "Temporary_Files", "MODELO_INTERNO_1_0", "db")
        logs_dir = os.path.join(ruta_proyecto, "Files", "Temporary_Files", "MODELO_INTERNO_1_0", "logs")
...
def setup_logging():
    ...
    try:
        ...
        log_directory = project_root / "Files" / "Temporary_Files" / "MODELO_INTERNO_1_0" / "logs"
...
def main():
    try:
        ...
        # Definir directorios
        validaciones_dir = project_root / "Files" / "Temporary_Files" / "MODELO_INTERNO_1_0" / "Validaciones_Calidad"
        db_dir = project_root / "Files" / "Temporary_Files" / "MODELO_INTERNO_1_0" / "db"
