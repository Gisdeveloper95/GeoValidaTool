...
class WordAutomation:
    def __init__(self):
        ...
        try:
            ...
            self.temp_root = self.root_path / "Files" / "Temporary_Files" / "MODELO_INTERNO_1_0"
            ...
            self.db_paths = {
                ...
                'registro_errores': self.temp_root / "db" / "registro_errores_urbano.db",
            ...
            self.error_ranges = {
                ...
                'no_superponer': (17, 37),  # R17 - R37
                'cubierto_por': (38, 53),   # R38 - R53
                'cubrirse_entre': (54, 57)  # R54 - R57
            }
            
            # Rango para consistencia
            self.consistencia_range = (58, 71)  # R58 - R71
        ...
        try:
            ...
            while current.parent != current:
                ...
                required_paths = [
                    ...
                    current / "Files" / "Templates" / "MODELO_INTERNO_1_0"/ "04_REPORTE_FINAL",
            ...
            raise Exception(
                ...
                "- Files/Temporary_Files/MODELO_INTERNO_1_0\n"
                "- Files/Temporary_Files/array_config.txt\n"
                "- Files/Templates/MODELO_INTERNO_1_0/04_REPORTE_FINAL\n"
    ...
    def verify_paths(self):
        ...
        try:
            ...
            paths_to_check = [
                self.root_path / "Files" / "Templates" / "MODELO_INTERNO_1_0"/ "04_REPORTE_FINAL",
                self.temp_root,
                self.temp_root / "db"
            ]
    ...
    def copy_templates(self):
        ...
        try:
            ...
            for dataset in self.datasets_to_process:
                template_path = self.root_path / "Files" / "Templates" / "MODELO_INTERNO_1_0"/ "04_REPORTE_FINAL" / dataset
    ...
    def get_conteo_variables(self, dataset, municipio):
        ...
        base_vars = [
            ...
            'cr_terreno', 
            'extdireccion',
            'vm_zonahomogeneageoeconomicarural',
            'vm_zonahomogeneafisicarural',
            'vm_zonahomogeneageoeconomicaurbana',
            'vm_zonahomogeneafisicaurbana',
            'cc_limitemunicipio',
            'cc_sectorrural',
            'cc_sectorurbano',
            'cc_perimetrourbano',
        ...
        try:
            ...
            try:
                # Nueva consulta para total_conteo usando SUM
                total_query = f"SELECT COALESCE(SUM({' + '.join(base_vars)}), 0) FROM conteos LIMIT 1"
