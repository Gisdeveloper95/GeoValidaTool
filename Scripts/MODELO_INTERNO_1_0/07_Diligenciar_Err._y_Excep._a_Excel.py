...
class TopologyAnalyzer:
    def __init__(self):
        ...
        self.cell_ranges = {
            'Consistencia Topologica': [
                ('H6', 'H21', 'I6', 'R_1', 'R_16'),
                ('H23', 'H43', 'I23', 'R_17', 'R_37'),
                ('H45', 'H60', 'I45', 'R_38', 'R_53'),
                ('H62', 'H65', 'I62', 'R_54', 'R_57')
            ],
    ...
    def get_project_root(self):
        ...
        while current_path.parent != current_path:
            required_paths = [
                current_path / "Files" / "Templates" / "MODELO_INTERNO_1_0" / "02_TOPOLOGIA",
                current_path / "Files" / "Temporary_Files" / "MODELO_INTERNO_1_0",
                current_path / "Files" / "Temporary_Files" / "array_config.txt",
                current_path / "Files" / "Temporary_Files" / "MODELO_INTERNO_1_0" / "db",
                current_path / "Files" / "Temporary_Files" / "MODELO_INTERNO_1_0" / "02_TOPOLOGIA"
            ]
    ...
    def copy_excel_template(self):
        ...
        template_topologia_path = os.path.join(self.templates_path, 'MODELO_INTERNO_1_0', '02_TOPOLOGIA')
    ...
    def setup_folders(self):
        ...
        topology_template_path = os.path.join(self.templates_path, 'MODELO_INTERNO_1_0', '02_TOPOLOGIA')
